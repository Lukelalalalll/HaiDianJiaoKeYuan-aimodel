...
public class ServletUtils {
    ...
    public static void setFileDownloadHeader(HttpServletRequest request, HttpServletResponse response, String fileName) {
        ...
        if (isMSIE) {
            ...
            encodedfileName = new String(fileName.getBytes(), Charset.forName("ISO-8859-1"));
        }
    ...
    public static boolean isIntranetAddress(String url) {
        try {
            URL u = new URL(url);
            String host = u.getHost();
            return INTRANET_IP_PATTERN.matcher(host).matches() || "localhost".equals(host);
        } catch (Exception e) {
            return false;
        }
    }
