...
@AllArgsConstructor
@Builder
@Table(name="t_ai_user_session_model_context_fileindex")
@ApiModel(value = "TAiUserSessionModelContextFileindex", description = "用户提问会话中的知识库文件索引")
public class TAiUserSessionModelContextFileindex extends AbstractBaseDomain {
